  ...
  return (
    <div>
      <div style={{width:'25%'}}>
        ...
        <button style={{padding:'10px', background:'rgb(20, 9, 80',  color:'#fff', fontWeight:'bold', fontFamily:'Poppins', borderRadius:'30px', fontSize:'16px', marginTop:'20px', position:'relative', left:'90%', width:'30%' }}>Submit</button>
      </div>
